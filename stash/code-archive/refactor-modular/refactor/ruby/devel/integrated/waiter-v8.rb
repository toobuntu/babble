...
def read_single_char
  ...
  if char == "\e" # Escape character
    ...
    'Tab'
  elsif char == "\u007F"  # Backward Delete on macOS 15 Sequoia; Forward Delete on macOS <= 14 Sonoma
    'Delete'
  elsif char == "\u0008"  # aka "\b"; Backward Delete on macOS <= 14 Sonoma
    'Backspace'
  else
